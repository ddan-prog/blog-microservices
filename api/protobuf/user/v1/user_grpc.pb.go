...
const (
	UserService_ListUsersByIDs_FullMethodName    = "/api.protobuf.user.v1.UserService/ListUsersByIDs"
	UserService_GetUser_FullMethodName           = "/api.protobuf.user.v1.UserService/GetUser"
	UserService_GetUserByEmail_FullMethodName    = "/api.protobuf.user.v1.UserService/GetUserByEmail"
	UserService_GetUserByUsername_FullMethodName = "/api.protobuf.user.v1.UserService/GetUserByUsername"
	UserService_CreateUser_FullMethodName        = "/api.protobuf.user.v1.UserService/CreateUser"
	UserService_UpdateUser_FullMethodName        = "/api.protobuf.user.v1.UserService/UpdateUser"
	UserService_DeleteUser_FullMethodName        = "/api.protobuf.user.v1.UserService/DeleteUser"
)
...
func (c *userServiceClient) ListUsersByIDs(ctx context.Context, in *ListUsersByIDsRequest, opts ...grpc.CallOption) (*ListUsersByIDsResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserService_ListUsersByIDs_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_ListUsersByIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_ListUsersByIDs_FullMethodName,
	}
